...
# 验证属级是否限制为10条
print(f'属级限制10条: {len(genus_matches) <= 10}')

# 检查关键布局元素
print('\n=== 布局检查 ===')
print('1. 页面高度设置:', 'height: 297mm' in html)
print('2. 仪表盘固定高度:', 'height: 75mm' in html)
print('3. 4个mini-card存在:', html.count('mini-card') >= 4)
print('4. 肠道年龄卡片:', '肠道年龄' in html)
print('5. B/E比值卡片:', 'B/E比值' in html)

# 保存HTML用于检查
with open('test_page2.html', 'w', encoding='utf-8') as f:
    f.write(html)
print('6. 已保存测试文件: test_page2.html')
